...
class RegressionModel(object):
    ...
    def __init__(self):
        ...
        self.paramArray = [self.w0, self.w1, self.w2, self.b0, self.b1, self.b2]
...
class LanguageIDModel(object):
    ...
    def __init__(self):
        ...
        self.w2 = nn.Parameter(400 , self.n)
        self.b0 = nn.Parameter(1, 400)
        self.b1 = nn.Parameter(1, 400)
        self.b2 = nn.Parameter(1, self.n)
    ...
    def run(self, xs):
        ...
        Returns:
            A node with shape (batch_size x 5) containing predicted scores
                (also called logits)
        """
        vec = nn.Linear(nn.DataNode(xs[0].data), self.w0)
        for x in xs:
            vec = nn.ReLU(nn.AddBias(nn.Linear(nn.Add(nn.Linear(x, self.w0), vec), self.w1), self.b1))
        output = nn.AddBias(nn.Linear(vec, self.w2), self.b2)
        return output
